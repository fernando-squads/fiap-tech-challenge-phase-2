...
def test_compile_model():
    ...
    logger.info("Testando a compilação do modelo")
    ...
    logger.info(f"Construindo o modelo ...")

    model = build_model(X_train.shape[1], neurons, dropout, learning_rate)

    logger.info(f"Construindo o modelo ...(OK)")

    logger.info(f"Iniciando compilação do modelo")
    ...
    logger.info(f"Modelo compilado com sucesso")
